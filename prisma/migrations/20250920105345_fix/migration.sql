/*
  ...
  - The values [update_committee] on the enum `proposal_category` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."proposal_category_new" AS ENUM ('info_action', 'parameter_change', 'treasury_withdrawals', 'hard_fork_initiation', 'new_committee', 'new_constitution', 'no_confidence');
